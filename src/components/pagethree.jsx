        ...
        <div>
            ...
            <div className="grid grid-flow-row mx-auto md:grid-cols-2 w-9/10">
                ...
                <div className="grid grid-flow-row ">
                    ...
                    <p className="mt-6 text-lg font-semibold text-left md:-mt-24 ">
            ...
            <button className="p-2 px-12 mt-4 text-xl text-center text-white bg-black rounded-lg md:mt-0 " onClick={() => {
                setpage(page + 1)
            }}>
                Continue
            </button>
